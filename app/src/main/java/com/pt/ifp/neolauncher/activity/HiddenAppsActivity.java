...
import com.pt.ifp.neolauncher.adapter.HiddenAppsAdapter;
...
public class HiddenAppsActivity extends Activity {
	...
	protected void onCreate(Bundle state) {
		...
		BackgroundBlur.blurIfTrue(getWindow(), NeoLauncherApp.getPrefs(this).getBackgroundBlurRadius());
	...
	private void showHiddenAppOptions(ComponentName componentName) {
		...
		OptionsDialog.show(this, R.string.edit_app,
				...
				(view, which) -> {
					switch (which) {
						case 0:
							NeoLauncherApp.appMenu.hiddenApps.removeAndStore(
						...
						case 1:
							...
							break;
						case 2:
							NeoLauncherApp.appMenu.launchAppInfo(this,
									componentName.getPackageName());
							break;
					}
				});
	...
	private void loadHiddenApps() {
		...
		Executors.newSingleThreadExecutor().execute(() -> {
			...
			for (ComponentName componentName :
					NeoLauncherApp.appMenu.hiddenApps.componentNames) {
