package com.pt.ifp.neolauncher.app;
...
import com.pt.ifp.neolauncher.receiver.ConfigurationChangedReceiver;
import com.pt.ifp.neolauncher.receiver.ManagedProfileEventReceiver;
import com.pt.ifp.neolauncher.receiver.PackageEventReceiver;

public class NeoLauncherApp extends Application {
	...
	private void registerLauncherAppsCallback() {
		...
		launcherApps.registerCallback(new LauncherApps.Callback() {
			...
			public void onPackageAdded(String packageName,
					UserHandle user) {
				appMenu.indexAppsAsync(NeoLauncherApp.this, packageName, user);
			}
			...
			public void onPackageRemoved(String packageName,
					UserHandle user) {
				appMenu.removePackage(NeoLauncherApp.this, packageName, user);
			}
