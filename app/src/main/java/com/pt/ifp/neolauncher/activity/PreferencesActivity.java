...
import com.pt.ifp.neolauncher.os.BatteryOptimization;
import com.pt.ifp.neolauncher.os.DefaultLauncher;
...
import com.pt.ifp.neolauncher.widget.ScrollWithListenerView;
...
public class PreferencesActivity extends Activity {
	...
	public static boolean isReady(Context context) {
		return NeoLauncherApp.getPrefs(context).skipSetup() ||
	...
	protected void onCreate(Bundle state) {
		...
		BackgroundBlur.blurIfTrue(getWindow(), prefs.getBackgroundBlurRadius());
	...
	private void initPreferences() {
		...
		initPreference(R.id.icon_pack,
				...
				() -> NeoLauncherApp.iconPack.updatePacks(
						getPackageManager()));
	...
	private Map<String, String> getIconPackOptions() {
		...
		map.putAll(NeoLauncherApp.iconPack.getIconPacks());
		return map;
	}
