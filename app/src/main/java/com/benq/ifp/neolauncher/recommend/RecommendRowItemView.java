...
public class RecommendRowItemView extends FrameLayout {
    ...
    public RecommendRowItemView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attributeSet, R.styleable.BenQ, 0, 0);
        try {
            String text = a.getString(R.styleable.BenQ_text);
            tvTitle.setText(text);

            mImageId = a.getResourceId(R.styleable.BenQ_drawable, 0);
            mImageIdFocus = a.getResourceId(R.styleable.BenQ_drawable_focused, 0);
